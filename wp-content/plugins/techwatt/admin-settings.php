...
function register_settings() {
        ...
        add_settings_field( 'tw_cadmin_url', 'Custom Admin Login Url:', function() {
            echo '<input type="text" name="tw_cadmin_url" value="'.esc_attr(get_option('tw_cadmin_url')).'" class="regular-text"><p class="description"><b>Example:</b> Enter backend → You admin login url will be https://www.yourdomain.com/backend instead of https://www.yourdomain.com/wp-admin. Use a lowercase (alphabets only)</p>'; }, 'techwatt-smtp', 'tw_email_section' );

        add_settings_field( 'tw_setting_hr1', '', function() { echo '<hr></div>'; }, 'techwatt-smtp', 'tw_email_section' );
        ...
        add_settings_field( 'tw_smtp_username', 'SMTP Username / API Email Sender:', function() {
        ...
        register_setting( 'techwatt-smtp', 'tw_cadmin_url');
    }

    ////////////////////
    function register_settings_page() {
        if (!current_user_can('manage_options')) return;
        ////////Rewrite Rules Flush if form submitted //////////
        ?>
        <div class="wrap">
            <h1>Techwatt Settings</h1>
    ...
    function register_menus() {
        add_submenu_page('techwatt-dashboard', 'Techwatt Settings', 'Techwatt Settings', 'manage_options', 'techwatt-smtp', 'register_settings_page');
    }
